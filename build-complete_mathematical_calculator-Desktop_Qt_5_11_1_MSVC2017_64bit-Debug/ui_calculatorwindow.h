...
public:
    ...
    void setupUi(QDialog *CalculatorWindow)
    {
        ...
        pBtn_bracketLeft = new QPushButton(CalculatorWindow);
        pBtn_bracketLeft->setObjectName(QStringLiteral("pBtn_bracketLeft"));
        pBtn_bracketLeft->setGeometry(QRect(0, 270, 50, 50));
        sizePolicy.setHeightForWidth(pBtn_bracketLeft->sizePolicy().hasHeightForWidth());
        pBtn_bracketLeft->setSizePolicy(sizePolicy);
        pBtn_bracketLeft->setFont(font1);
        ...
        pBtn_Pi->setGeometry(QRect(0, 120, 50, 50));
        ...
        pBtn_bracketRight = new QPushButton(CalculatorWindow);
        pBtn_bracketRight->setObjectName(QStringLiteral("pBtn_bracketRight"));
        pBtn_bracketRight->setGeometry(QRect(50, 270, 50, 50));
        sizePolicy.setHeightForWidth(pBtn_bracketRight->sizePolicy().hasHeightForWidth());
        pBtn_bracketRight->setSizePolicy(sizePolicy);
        pBtn_bracketRight->setFont(font1);
        ...
        pBtn_plusOrMinus->setGeometry(QRect(0, 220, 50, 50));
        ...
        pBtn_exp->setGeometry(QRect(200, 70, 50, 50));
    ...
    void retranslateUi(QDialog *CalculatorWindow)
    {
        ...
        pBtn_bracketLeft->setText(QApplication::translate("CalculatorWindow", "(", nullptr));
        ...
        pBtn_Pi->setText(QApplication::translate("CalculatorWindow", "\317\200", nullptr));
        ...
        pBtn_bracketRight->setText(QApplication::translate("CalculatorWindow", ")", nullptr));
